    ...
    <div className="space-y-12">
      ...
      <div className="p-6 md:p-12 lg:p-16 text-center flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 p-4 text-black text-center">
          <h1 className="text-3xl md:text-8xl font-extralight mt-8">
            Contact Us
          </h1>
          <h2 className="text-xl text-black md:text-2xl mt-2">
            We’d Love to Hear From You
          </h2>
          <p className="text-lg text-black md:text-xl mt-4 max-w-2xl mx-auto">
      ...
      <div className="p-6 md:p-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={index}
              className={`p-6 rounded-lg shadow-lg text-center ${info.bgColor}`}
            >
              <div
                className={`flex justify-center items-center h-16 w-16 mx-auto rounded-full ${info.textColor} bg-opacity-75`}
              >
                {info.icon}
              </div>
              <h3 className={`text-xl font-semibold mt-4 ${info.textColor}`}>
                {info.title}
              </h3>
              <p className={`mt-2 ${info.textColor}`}>{info.description}</p>
            </div>
          ))}
        </div>
      </div>
      {/* Map */}
      <div className="p-6 md:p-12">
        <h3 className="text-6xl font-light mb-4 text-center">Our Location</h3>
      ...
      <div className="p-6 md:p-12">
        <div className="text-center mb-6">
          ...
          <p className="text-lg">Some of the most frequently asked questions</p>
        </div>
        <div className="w-full md:w-3/4 lg:w-1/2 mx-auto">
          {[
            ...
            <div key={index} className="mb-4">
              <div
                className={`border-t border-gray-200 py-4 transition duration-300 ease-in-out ${
                  activeIndex === index ? "#c5ffc4" : "#c2cdff"
                }`}
              >
                <div
                ...
                {activeIndex === index && (
                  <p className="mt-2 text-gray-600 transition-transform duration-300 ease-in-out">
                    {faq.answer}
                  </p>
                )}
              </div>
